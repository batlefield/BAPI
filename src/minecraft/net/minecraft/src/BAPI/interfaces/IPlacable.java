...
{
    /**
     * This is called before player tries to place any of the blocks that extend
     * BlockFlower.class
     *
    ...
    /**
     * This is called before player tries to place cactus
     *
     * @param plantableID			ID of the block that player tries to place flower on
     * @param plantableMeta			metadata of the block that player tries to place flower on
     * @return
    ...
    /**
     * This is called before player tries to place reeds
     *
     * @param plantableID			ID of the block that player tries to place flower on
     * @param plantableMeta			metadata of the block that player tries to place flower on
     * @return
    ...
    /**
     * This is called before player tries to place torch or redstone torch(usefull for placing torches on top of fences)
     *
