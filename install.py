...
BAPI_dir = os.path.dirname(os.path.abspath(__file__))
mcp_dir = os.path.abspath('..')
src_dir = os.path.join(mcp_dir, 'src')
forge_dir = os.path.join(mcp_dir, 'forge')
...
def main():
    ...
    if has_client:
        if os.path.isdir(os.path.join(BAPI_dir, 'patches', 'minecraft')):
            apply_patches(os.path.join(BAPI_dir, 'patches', 'minecraft'), src_dir)
        if os.path.isdir(os.path.join(BAPI_dir, 'src', 'minecraft')):
            copytree(os.path.join(BAPI_dir, 'src', 'minecraft'), os.path.join(src_dir, 'minecraft'))
    if has_server:
        if os.path.isdir(os.path.join(BAPI_dir, 'patches', 'minecraft_server')):
            apply_patches(os.path.join(BAPI_dir, 'patches', 'minecraft_server'), src_dir)
        if os.path.isdir(os.path.join(BAPI_dir, 'src', 'minecraft_server')):
            copytree(os.path.join(BAPI_dir, 'src', 'minecraft_server'), os.path.join(src_dir, 'minecraft_server'))
